...
async function testEmail() {
  ...
  console.log('SENDGRID_FROM_EMAIL:', process.env.SENDGRID_FROM_EMAIL || 'noreply@dubsea.com (default)');
  console.log('');
  ...
  try {
    ...
    const msg = {
      to: 'saadullah@dubsea.com',
      from: process.env.SENDGRID_FROM_EMAIL || 'noreply@dubsea.com',
    ...
    console.log('\nCheck saadullah@dubsea.com inbox!');
  } catch (error) {
